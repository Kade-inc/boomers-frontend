  ...
  return (
    <div className="min-h-screen bg-base-100">
      <div className="flex md:w-1/2 mx-auto">
        ...
        {hasAnyResults && (
          <aside className="hidden md:block w-48 p-4 sticky top-0 h-screen">
        ...
        {/* Main Content */}
        <main className="flex-1 flex flex-col gap-10 p-4 md:pl-2 w-full mx-auto">
          {/* Challenges Section */}
          {(isPending ||
            (searchResult?.challenges.results &&
              searchResult.challenges.results.length > 0)) && (
            <section
              id="challenges"
              className="bg-base-100 border rounded p-4 md:p-8"
            >
              <h2 className="text-xl font-semibold mb-6 font-body">
                Challenges
              </h2>
              {isPending ? (
