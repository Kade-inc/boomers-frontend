  ...
  return (
    <div className=" h-screen bg-base-100 px-10 pt-10 font-body">
      ...
      <div className="flex gap-8 mb-[30px]">
        ...
        <div className="border-[1px] border-yellow w-[100px] flex items-center gap-3 text-[12px] justify-center rounded-[1px]">
          Expand <MdOutlineKeyboardArrowDown className="size-4" />
        </div>
      </div>
      ...
      <div className="flex gap-8 mb-[30px] ">
        ...
        <div className="border-[1px] border-yellow w-[100px] flex items-center gap-3 text-[12px] justify-center rounded-[1px]">
          Collapse <MdOutlineKeyboardArrowDown className="size-4" />
        </div>
      </div>
