        ...
        >
          ...
          <div className="w-full mb-[9%]">
            ...
            <div className="flex justify-end items-center relative">
              {showPassword ? (
                <EyeSlashIcon
                  className="absolute text-darkgrey inset-y-0 right-3 flex items-center pl-2 w-8 h-8 top-2.5 cursor-pointer"
              ...
              <input
                ...
                className="input w-full border text-darkgrey border-darkgrey bg-transparent rounded-md font-body placeholder-lightgrey text-[12px] hover:border-gray-700 focus:outline-none lg:text-[15px]"
          ...
          <div className="mb-[9%]">
            ...
            <div className="flex justify-end items-center relative">
              ...
              <input
                ...
                className="input w-full text-darkgrey border border-darkgrey bg-transparent rounded-md font-body placeholder-lightgrey text-[12px] hover:border-gray-700 focus:outline-none lg:text-[15px]"
              />
            </div>
