  ...
  return (
    <div className="navbar bg-base-100 flex md:px-5 justify-between px-5">
      ...
      <div className="lg:w-[20%] justify-start items-center relative hidden md:flex">
        ...
        <input type="text" placeholder="Search team/users" className="input md:w-auto rounded-full pl-10 text-[12px] md:text-base font-body bg-grey" />
      </div>
      ...
      <div className="flex">
        <div className="hidden lg:grid  lg:grid-flow-col lg:gap-8 lg:auto-rows-max lg:mr-[70px]">
          ...
          <Link className={pathname === "/messages" ? "btn btn-ghost bg-yellow rounded-full" : "flex items-center"} to="/messages">
          <div className={"flex items-center text-[16px] font-body font-normal"}>
            ...
            <Link className={pathname === "/teams" ? "btn btn-ghost bg-yellow rounded-full" : "flex items-center"} to="/teams">
            <div className="flex items-center text-[16px] font-body font-normal">
