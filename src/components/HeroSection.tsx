...
const HeroSection = ({
    ...
    return (
      <div className="relative w-full h-screen bg-gray-900 text-white py-20 md:py-32 px-4 overflow-hidden">
        {/* login link */}
        <div className="absolute top-4 right-4 md:top-8 md:right-8 z-20">
          <Link to="/auth/login">
            <Button
              variant="ghost"
              className="text-yellow hover:text-yellow/60 hover:bg-yellow/40"
            >
              Login
            </Button>
          </Link>
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -right-10 -top-10 w-64 h-64 bg-yellow opacity-10 rounded-full blur-3xl"></div>
          <div className="absolute -left-20 bottom-0 w-80 h-80 bg-yellow opacity-10 rounded-full blur-3xl"></div>
          <div className="absolute right-1/4 top-1/3 w-40 h-40 bg-yellow opacity-5 rounded-full blur-xl"></div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-6 leading-tight">
                <span className="relative inline-block md:text-7xl">
                  <span className="whitespace-nowrap">
                    Level Up Your{" "}
                    <span className="relative inline-block overflow-hidden text-left">
                      <motion.span
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Button
                  ...
                  className="bg-yellow hover:bg-yellow/60 text-black font-medium px-8 py-6 h-auto text-lg"
                >
                  Join The Community
                </Button>
                ...
                <Button
                  ...
                  variant={"outline"}
                  className="border-yellow text-yellow hover:bg-yellow/10 font-medium px-8 py-6 h-auto text-lg flex items-center gap-2"
                >
            ...
            >
                <div className="relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-yellow to-yellow/70 rounded-lg blur opacity-30"></div>
                    <div className="relative bg-gray-800 p-6 rounded-lg shadow-xl">
                        <div className="aspect-video rounded-md overflow-hidden bg-gray-700 flex items-center justify-center relative">
                            <motion.img
                        ...
                        <div className="mt-4 p-4 bg-gray-900 rounded-md border border-gray-700">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="h-2 bg-yellow/30 rounded-full w-1/2"></div>
                            </div>
                        </div>
                    </div>
                </div>
