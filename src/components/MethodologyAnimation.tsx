          ...
          <div className="relative">
            ...
            <div className="flex justify-between mb-8">
              {steps.map((step, index) => (
                ...
                >
                  <motion.div
                    className={`w-10 h-10 rounded-full flex items-center justify-center cursor-pointer ${activeStep === index ? "bg-yellow" : "bg-gray-200"}`}
                    animate={{
                  ...
                  <span
                    className={`text-xs mt-2 ${activeStep === index ? "font-bold" : ""}`}
                  >
                    {step.title}
                  </span>
                </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                      {activeStep === 0 && (
                        <>
                          <Card className="w-full md:w-auto bg-gray-50 border-yellow border-1-4">
                          ...
                          <Card className="w-full md:w-auto bg-gray-50">
                            <CardContent className="p-4">
                              <p className="text-sm text-black">
                      ...
                      {activeStep === 2 && (
                        <>
                          <Card className="w-full md:auto bg-gray-50 border-yellow border-1-4">
                            <CardContent className="p-4">
