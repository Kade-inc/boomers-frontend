            ...
            <div className="flex justify-between w-full">
              <div className="flex-grow text-[12px]">
                <div className="flex items-center mb-2 font-medium">
                  {team.domain} <div className="bg-white rounded-full w-1 h-1 mx-1"></div> {team.subdomain} <div className="bg-white rounded-full w-1 h-1 mx-1"></div>  {team.subdomainTopics[0]}{" "}
